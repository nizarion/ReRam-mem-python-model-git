...
Trt = 300                       #Ambient temperature in degrees C
de = 50 * 10**-9                #Electrode thickness
do = 10 * 10**-9                #Oxide thickness
ke = 363.12                     #Effective electrode thermal conductivity - Usually higher than bulk values due to spreading effects
Lwf = 2.44 * 10**-8             #Wiedemann-Franz constant

sigSat = 9.81 * 10**5           #Saturation Conductivity in the Filament
maxConc = 100                   #The maximum concentration of oxygen vacancies or dopants in arbitrary units
minConc = 50                    #The minimum concentration of oxygen vacancies or dopants in arbitrary units
a = 0.00828                     #Amplitude coefficient for Poole-Frenkel contribution
b = 4.514                       #Nonlinearity coefficient for Poole-Frenkel contribution
...
#Forming
formingRadius = (2 * 10**-9)/shellSize              #Set the forming radius
...
#Switch On
CurrSpacing = np.linspace(0,6*10**-3,50)                #Use current sourcing to sweep from 0 to 6 mA
...
#Switch Off 
VoltSpacing = np.linspace(0,-1.0,50)                    #Use voltage sourcing to sweep from 0 to -1.0 V
