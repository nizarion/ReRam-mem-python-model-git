...
de = 50 * 10**-9            #Electrode thickness in meters
do = 10 * 10**-9            #Oxide thickness in meters
Lwf = 2.44 * 10**-8         #Wiedemann-Franz constant
Trt = 300                   #Ambient temperature in Kelvin
...
###########  Load and Fit Data  ##############
IVdata = csv.reader(open('onSwitch-sn7cuc13-2ndpos-309-390v1.csv','rb'))      #A csv file is used where the columns are voltage then current. 
